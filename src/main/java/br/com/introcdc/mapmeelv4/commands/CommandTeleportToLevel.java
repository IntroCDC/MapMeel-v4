...
/*
 * Written by IntroCDC, Bruno Coêlho at 05/04/2020 - 20:20
 */
...
public class CommandTeleportToLevel extends CommandBase {

    public CommandTeleportToLevel() {
        super("teleporttolevel", "tptolevel");
        this.onlyStaff = true;
    }
    ...
    public void onExecute(CommandSender sender, String label, String[] args) throws Exception {
        ...
        if (args.length > 0) {
            ...
            getPlayer(sender.getName()).teleport(level.getPortalSpec());
            sender.sendMessage(MapUtils.PREFIX + "Teleportado!");
            return;
        }
