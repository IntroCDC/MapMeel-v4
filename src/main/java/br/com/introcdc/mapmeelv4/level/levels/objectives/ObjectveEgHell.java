...
/*
 * Written by IntroCDC, Bruno Coêlho at 05/04/2020 - 21:49
 */
...
public class ObjectveEgHell extends LevelObjective {

    public ObjectveEgHell() {
        super("No Ponto Mais Alto", new Location(Bukkit.getWorld("EG-HELL"), -104, 256, -639, -181, 90), true, true, false);
    }
