...
public class Level3A extends Level {
    ...
    public Level3A() {
        super(
                ...
                new LevelObjective[]{
                        new LevelObjective("O Grande Navio", MapUtils.getLocation("3A", -56, 118, 3, -359, 13), true),
                        new LevelObjective("O Final do Alto Parkour", MapUtils.getLocation("3A", 104, 150, -27, -240, 46), true),
